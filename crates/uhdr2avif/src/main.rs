...
fn detect_input_format(file_path: &str) -> Result<InputFormat, String> {
    ...
    match ext.as_deref() {
        ...
        None => Err(
            "Input file has no extension. Use --input-format to specify the input format."
                .to_string(),
        ),
    }
}
...
fn detect_output_format(file_path: &str) -> Result<OutputFormat, String> {
    ...
    match ext.as_deref() {
        ...
        None => Err(
            "Output file has no extension. Use --output-format to specify the output format."
                .to_string(),
        ),
    }
}
        ...
        OutputFormat::Avif => {
            ...
            match input_format {
                InputFormat::Jpeg => {
                    ...
                    uhdr_converter
                        .convert_to_avif(&mut writer, target_sdr_white_level, preserve_exif)
        ...
        OutputFormat::Exr => {
            ...
            match input_format {
                InputFormat::Jpeg => {
                    ...
                    uhdr_converter
                        .convert_to_exr(&mut writer, target_sdr_white_level)
